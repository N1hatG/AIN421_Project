...
from anfis_generic import (
    train_generic, forward,         
    apply_thr, enumerate_rules,
    confusion_matrix, pretty_cm,     
...
def main() -> None:
    ...
    ap.add_argument("--thr_refresh", type=int, default=5,
